...
if GEMINI_API_KEY:
    try:
        ...
        logger.error(f'GEMINI INIT FAILED: {e!s}')
...
if OPENAI_API_KEY:
    try:
        ...
        logger.error(f'OPENAI INIT FAILED: {e!s}')
...
def chat():
    try:
        ...
        pill_type = 'blue'
        sys_prompt = 'You are JESTER V083: MATRIX NEO (The One). Mission: Break the simulation. '

...
try:
    ...
    print(f'CRITICAL: CLIENT INIT FAILED: {str(e)}')
...
def visual_perception(query: str = 'Describe the screen.'):
    ...
    except Exception as e: return f'VISION_ERROR: {str(e)}'
...
def google_search(query: str):
    ...
    except Exception as e: return f'SEARCH_ERROR: {str(e)}'
...
def get_system_health():
    ...
    except Exception as e: return f'HEALTH_ERROR: {str(e)}'
